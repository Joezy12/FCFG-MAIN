    ...
    return (
       ...
       {userDetails ?  <div className="settings">
            ...
            <div className="profile-box">
                <div className="profile-pic" style={{background: `url(${userDetails.legalFName == "Lydia" ? chib : 'https://cdn3d.iconscout.com/3d/premium/thumb/business-woman-6779094-5580737.png'})`, backgroundSize: "cover"}}></div>
